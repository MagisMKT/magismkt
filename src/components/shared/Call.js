...
function Call() {
  return (
    <section className="z-40 relative py-8 lg:py-10 flex pl-[20px] lg:pl-[200px]">
      <div className="relative ml-auto bg-green flex flex-col gap-4 items-center w-full h-full justify-center py-12 lg:py-28 z-20 rounded-l-[120px] bg-[url('/images/bg-lines.svg')] bg-cover">
        ...
        <Image src="/images/brenda_session.png" width="180" height="180" />
